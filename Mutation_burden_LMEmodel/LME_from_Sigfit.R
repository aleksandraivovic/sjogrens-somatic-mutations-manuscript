### LME model from adjusted mutation burden and Sigfit mutational signatures 
# adapted Sept 2025
...
# load original mutcounts file for sample IDs
...
#----------------------------------------------------------
## Load metadata file with VAF, Depth, and sensitivity adjustment calculated from VAFxDepth
sample_metadata = read.delim("lcm_all_metadata_wVAF_wSensitivity.tsv", header = T) # nrow 456
...
#pdf(file = "Mut_burden_Age_2107_Epith.pdf",   # The directory you want to save the file in
...
#pdf(file = "Mut_burden_Age_2107_Epith_byPt.pdf",   # The directory you want to save the file in
#    width = 8, # The width of the plot in inches
#    height = 5.5)
...
#pdf(file = "Apobec_Mut_burden_Age_2107_Epith_byPt.pdf",   # The directory you want to save the file in
...
#pdf(file = "Apobec_fraction_2107_Epith_byPt.pdf",   # The directory you want to save the file in
#    width = 4, # The width of the plot in inches
#    height = 5)
...
#pdf(file = "Sigs_barplot_ordered_byApobec.pdf",   # The directory you want to save the file in
